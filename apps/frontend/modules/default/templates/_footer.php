<div class="column span-18 quiet medium">
    <?php echo link_to('Contact Us', 'default/contact') ?>
		&middot; <?php echo link_to('Terms of Service', 'default/terms') ?>
	<?php if ($sf_user->isAuthenticated()): ?>
		&middot; <?php echo link_to('Instructions', 'default/instructions') ?> 
	<?php endif ?>
</div>
