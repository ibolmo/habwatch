...
CREATE TABLE report (id BIGSERIAL, file BYTEA, quantity BIGINT, _condition TEXT, subject TEXT, location TEXT, message_id BIGINT, storage_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
