...
CREATE TABLE report (id BIGSERIAL, file BYTEA, quantity BIGINT, condition TEXT, subject TEXT, location_id BIGINT, message_id BIGINT, storage_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
...
ALTER TABLE coordinate ADD FOREIGN KEY (report_id) REFERENCES report(id) NOT DEFERRABLE INITIALLY IMMEDIATE;
