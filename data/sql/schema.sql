...
CREATE TABLE message (id BIGSERIAL, file BYTEA, _from VARCHAR(125), _to VARCHAR(125), message TEXT, data_id BIGINT, type VARCHAR(255), carbon_copy TEXT, blind_carbon_copy TEXT, subject TEXT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
...
CREATE TABLE course (id BIGSERIAL, file BYTEA, speed FLOAT, heading FLOAT, heading_accuracy FLOAT, speed_accuracy FLOAT, g_p_s_id BIGINT, data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
CREATE TABLE data (id BIGSERIAL, sf_guard_user_id INT, PRIMARY KEY(id));
...
CREATE TABLE picture (id BIGSERIAL, file BYTEA, resolution BIGINT, quality VARCHAR(10), format VARCHAR(25), data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
CREATE TABLE position_table (id BIGSERIAL, file BYTEA, latitude FLOAT, altitude FLOAT, vertical_accuracy FLOAT, longitude FLOAT, horizontal_accuracy FLOAT, g_p_s_id BIGINT, data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
...
CREATE TABLE report (id BIGSERIAL, file BYTEA, quantity BIGINT, condition TEXT, subject TEXT, location_id BIGINT, message_id BIGINT, data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
CREATE TABLE satellites (id BIGSERIAL, file BYTEA, horizontal_dop FLOAT, used_satellites BIGINT, vertical_dop FLOAT, time FLOAT, satellites BIGINT, time_dop FLOAT, g_p_s_id BIGINT, data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
...
ALTER TABLE message ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE course ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE picture ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE position_table ADD FOREIGN KEY (g_p_s_id) REFERENCES g_p_s(id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE position_table ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
...
ALTER TABLE report ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE satellites ADD FOREIGN KEY (g_p_s_id) REFERENCES g_p_s(id) NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE satellites ADD FOREIGN KEY (data_id) REFERENCES data(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
