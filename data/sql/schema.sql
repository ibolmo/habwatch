...
CREATE TABLE report (id BIGSERIAL, file BYTEA, quantity BIGINT, condition TEXT, subject TEXT, message_id BIGINT, data_id BIGINT, created_at TIMESTAMP without time zone, updated_at TIMESTAMP without time zone, PRIMARY KEY(id));
